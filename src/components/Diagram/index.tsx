...
export default function Diagram() {
  ...
  useEffect(() => {
    const handleExport = () => {
      ...
      img.onload = () => {
        canvas.width = dimensions.width * 2; // High DPI
        ...
        if (ctx) {
          ...
          downloadLink.download = "schemalens-diagram.png";
    ...
    window.addEventListener("export-diagram-png", handleExport);
    return () => window.removeEventListener("export-diagram-png", handleExport);
  }, [dimensions]);
